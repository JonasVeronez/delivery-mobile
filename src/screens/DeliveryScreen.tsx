...
export default function DeliveryScreen() {
  ...
  useEffect(() => {
    ...
    const startTracking = async () => {
      ...
      if (role !== "DELIVERY") {
        console.log("Usuário não é motoboy, GPS desativado");
        return;
      }
      ...
      subscription = await Location.watchPositionAsync(
        ...
        async (location) => {
          ...
          if (accuracy && accuracy > 30) {
            console.log("GPS impreciso ignorado:", accuracy);
            return;
          }
          ...
          console.log("Nova posição:", newLocation);
          ...
          try {
            ...
            console.log("Erro enviando localização:", e);
          }
        ...
        {myLocation && (
          ...
          <View style={styles.mapWrapper}>
            ...
            <MapView
              style={styles.map}
              initialRegion={{
                latitude: item.deliveryLocation?.latitude || myLocation.latitude,
                longitude: item.deliveryLocation?.longitude || myLocation.longitude,
                latitudeDelta: 0.01,
                longitudeDelta: 0.01
              }}
            >
